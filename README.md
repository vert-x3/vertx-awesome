...
* [Grooveex Todo-Backend implementation](https://github.com/aesteve/todo-backend-grooveex) : Todo MVC backend implementation with Vert.x + Groovy + some syntaxic sugar + DSL routing facilities
