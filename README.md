...
* Relational Databases
  ...
  * [jOOQx](https://github.com/zero88/jooqx) - `jOOQ.x` leverages the power of typesafe SQL from `jOOQ DSL` and running on SQL connection in a reactive and non-blocking of SQL driver from Vert.x
