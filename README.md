...
the icon <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px">
...
* [Vert.x Web](https://github.com/vert-x3/vertx-web)  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Full featured web toolkit for Vert.x.
...
* [Vert.x Auth JDBC](https://github.com/vert-x3/vertx-auth/tree/master/vertx-auth-jdbc)  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Vert.x authentication/authorisation JDBC based.
* [Vert.x Auth JWT](https://github.com/vert-x3/vertx-auth/tree/master/vertx-auth-jwt)  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Vert.x Authorisation based on JSON Web Tokens.
* [Vert.x Auth Shiro](https://github.com/vert-x3/vertx-auth/tree/master/vertx-auth-shiro)  <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Vert.x AuthN/AuthZ based on [Apache Shiro](http://shiro.apache.org/).
* [Vert.x-Pac4j](https://github.com/pac4j/vertx-pac4j)    <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Vert.x authentication/authorisation implemented using [pac4j](http://www.pac4j.org/).
...
* Relational Databases
  * [JDBC](https://github.com/vert-x3/vertx-jdbc-client) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Asynchronous interface around a JDBC datasource.
...
* NoSQL Databases
  * [MongoDB](https://github.com/vert-x3/vertx-mongo-client) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - An asynchronous client for interacting with a MongoDB database.
  * [Redis](https://github.com/vert-x3/vertx-redis-client) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Asynchronous API to interact with Redis.
...
* Mail
  * [SMTP](https://github.com/vert-x3/vertx-mail-client) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Async SMTP client.
...
* Messaging
  * [AMQP 1.0](https://github.com/vert-x3/vertx-amqp-bridge) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Interact with AMQP 1.0 servers using the Vert.x Producer and Consumer APIs.
  * [RabbitMQ](https://github.com/vert-x3/vertx-rabbitmq-client) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - A RabbitMQ client (AMQP 0.9.1).
...
* JavaEE
  * [JCA adaptor](https://github.com/vert-x3/vertx-jca) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Java Connector Architecture Adaptor for the Vert.x event bus.
...
* Metrics
  ...
  * [DropWizard metrics](https://github.com/vert-x3/vertx-dropwizard-metrics) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Metrics implementation using DropWizard metrics.
...
* [Ceylon](https://github.com/vert-x3/vertx-lang-ceylon) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Ceylon support.
* [Groovy](https://github.com/vert-x3/vertx-lang-groovy) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Groovy support.
* [Java](https://github.com/eclipse/vert.x) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Vert.x main repository (including the Java API).
* [JavaScript](https://github.com/vert-x3/vertx-lang-js) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - JavaScript support.
* [Python](https://github.com/vert-x3/vertx-lang-python) - Python support.
* [Ruby](https://github.com/vert-x3/vertx-lang-ruby) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Ruby support.
...
* [Reactive Streams](https://github.com/vert-x3/vertx-reactive-streams) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Vert.x Reactive Streams.
* [Reactive Extensions](https://github.com/vert-x3/vertx-rx) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Vert.x Reactive Extensions.
...
* [JavaScript](https://www.npmjs.com/package/vertx3-eventbus-client) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - JavaScript event bus client.
...
* [Hazelcast Cluster Manager](https://github.com/vert-x3/vertx-hazelcast) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Hazelcast cluster manager.
* [Ignite Cluster Manager](https://github.com/vert-x3/vertx-ignite) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Ignite cluster manager.
...
* [OpenShift DIY cartridge](https://github.com/vert-x3/vertx-openshift-diy-quickstart) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - OpenShift DIY Cartridge using Vert.x.
* [OpenShift Vert.x cartridge](https://github.com/vert-x3/vertx-openshift-cartridge) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - OpenShift Vert.x Cartridge using Vert.x.

## Docker

* [Docker images](https://github.com/vert-x3/vertx-stack/tree/master/stack-docker) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Docker images for Vert.x.
...
* [Service Factory](https://github.com/vert-x3/vertx-service-factory) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Vert.x Service Factory.
* [Maven Service Factory](https://github.com/vert-x3/vertx-maven-service-factory) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Maven Vert.x Service Factory.
* [HTTP Service Factory](https://github.com/vert-x3/vertx-http-service-factory) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Vert.x HTTP Service Factory.
...
* [Vert.x Unit](https://github.com/vert-x3/vertx-unit) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Async polyglot unit testing for Vert.x.
...
* [Vert.x Stack](https://github.com/vert-x3/vertx-stack) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - Vert.x + the endorsed modules.

## Examples

* [Vert.x examples](https://github.com/vert-x3/vertx-examples) <img src="vertx-favicon.svg" alt="(stack)" title="Vert.x Stack" style="max-height: 1.0em; margin-bottom: -2px"> - The official Vert.x examples including web examples, how to use the official database clients, etc.
